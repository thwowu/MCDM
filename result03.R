# probability, feasibility to 0

# Start writing to an output file
sink('analysis-1or0-pf-lp.txt')
...
# feasibility, synergy to 0

# Start writing to an output file
sink('analysis-1or0-fs-lp.txt')
# preference
ptm <- proc.time()
range1 <- c(5, 10) # [MIN, MAX] for NPV importance
...
# Start writing to an output file
sink('analysis-1or0-return-lp.txt')
# preference
range1 <- c(5, 10) # [MIN, MAX] for NPV importance
range2 <- c(0, 0) # [MIN, MAX] for probability importance
range3 <- c(0, 0) # [MIN, MAX] for feasibility importance
...
# Start writing to an output file
sink('analysis-1or0-return-ga.txt')
# preference
range1 <- c(5, 10) # [MIN, MAX] for NPV importance
range2 <- c(0, 0) # [MIN, MAX] for probability importance
range3 <- c(0, 0) # [MIN, MAX] for feasibility importance
